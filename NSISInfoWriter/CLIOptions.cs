...
namespace NSISInfoWriter
{
    public class CLIOptions
    {
        ...
        [Option('g', "ex-git", Default = false, HelpText = "Exclude git related information into output")]
        public bool ExcludeGit { get; set; }
        [Option('c', "ex-common", Default = false, HelpText = "Exclude common file information into output (size, name, etc.)")]
        public bool ExcludeCommon { get; set; }
        [Option('v', "ex-version", Default = false, HelpText = "Exclude version information into output")]
